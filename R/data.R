##' @title Eco Phylo Mapper datasets
##'
##' @description Included datasets in \code{epm}
##' 
##' @name epm-example
##' @docType data
##' 
...
##'
##'@details Included north american chipmunk dataset: \cr
...
##'
##'@references Zelditch, M. L., Ye, J., Mitchell, J. S., & Swiderski, D. L.
