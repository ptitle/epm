...
##'
##' @description Mean taxonomic community dissimilarity is 
...
##' 
##' 
##' @return Returns a grid with mean community dissimilarity for each cell.
##' 
##' @author Pascal Title
##'
##' @references
...
##' 
##' # taxonomic turnover
##' beta_taxonomic_turnover <- taxonomic_betadiv(tamiasEPM, radius = 70000, 
##' 		component = 'turnover')
##' beta_taxonomic_nestedness <- taxonomic_betadiv(tamiasEPM, radius = 70000, 
##'			component = 'nestedness')
##' beta_taxonomic_full <- taxonomic_betadiv(tamiasEPM, radius = 70000, 
##'			component = 'full')
##'
##' 
##' 
